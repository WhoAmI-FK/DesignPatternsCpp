...
namespace user_interface {
    ...
    protected:
        ...
        bool isVisible = true;
    public:
        InterfaceElement(const std::string& name, bool isVisible, Mediator* mediator) : mediator(mediator), name(name), isVisible(isVisible) {};
    ...
    public:
        ...
        if (isChecked) {
            ...
            mediator->mediate(name + " is not checked");
        }
        };
    };
    ...
    public:
        ...
        TextBox* getNameTextBox() const { return nameTextBox; };
        CheckBox* getIsMarriedCheckbox() const { return isMarriedCheckbox; };
        TextBox* getSpousesNameTextBox() const { return spousesNameTextBox; };
        ButtonElement* getSubmitButton() const { return submitButton; };
    };
};